...
針對常常開了幾十個分頁卻無從整理的你，提供「手動自訂群組」以及「**AI 智能多重分類**」幫助您一鍵把凌亂的分頁歸檔收納！

---

## 核心特色 (Features)

* **AI 智能多重分類：** 串接 Google Gemini AI，自動讀取您選取的分頁標題與網址，聰明理解意圖並拆分成多個適合的主題群組。
...
由於 AI 智能分類依賴 Google Gemini 的服務，您需要自己申請一個專屬的 API 金鑰（免費），金鑰將**絕對安全地保存在您瀏覽器的本地端 (Local Storage)**，不會外流。
...
5. 現在起，勾選您想要整理的分頁，按一下 **「執行 AI 智能分組」**，剩下的就交給強大的 AI 處理吧！
